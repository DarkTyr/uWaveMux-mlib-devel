...
function data_packetizer_sm_v2_config(this_block)

  % Revision History:
  %
  %   01-Jun-2015  (13:37 hours):
  %     Original code was machine generated by Xilinx's System Generator after parsing
  %     /home/pcuser/Documents/uWaveMux-mlib-devel/nist_library/data_handler/hdl/vhdl/data_packetizer_sm_v2.vhd
  %
  %

  this_block.setTopLevelLanguage('VHDL');

  this_block.setEntityName('data_packetizer_sm_v2');
  ...
  this_block.addSimulinkInport('frame_increment');
  this_block.addSimulinkInport('data_in_valid');
  this_block.addSimulinkInport('data_in_grab_frame');
  ...
  if (this_block.inputTypesKnown)
    ...
    if (this_block.port('frame_increment').width ~= 16);
      this_block.setError('Input data type for port "frame_increment" must have width=16.');
    end
    ...
    if (this_block.port('data_in_grab_frame').width ~= 1);
      this_block.setError('Input data type for port "data_in_grab_frame" must have width=1.');
    end

    this_block.port('data_in_grab_frame').useHDLVector(false);
